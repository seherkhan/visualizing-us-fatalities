<template>
  <div class="sankey" style="margin-right:15px;margin-left:15px">
    ...
    <p class="lead">United States, selected years 1950–2016. Includes deaths of persons who were not residents of the 50 states and the District of Columbia (D.C.).
...
var svg = d3.select("#svg-im").select(this.$refs["sankey"])
