<template>
  <div class="areawise">
    <div class="container" style="margin:25px">
      <h1 class="display-4" style="font-size:25px;font-weight:bold;">Area-wise Clustering</h1>		
			<p>United States, 1999-2016. Instances of cancer occurance by type and location.</p>
