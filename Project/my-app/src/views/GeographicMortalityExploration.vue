<template>
  ...
  <h1 class="lead" style="font-size:25px;font-weight:bold;"> Age-adjusted death rates, by race, Hispanic origin, state, and territory</h1>
  <p>The visualizations are used to display the death rates in United States and U.S. Dependent Areas. 
